...
changelog: PARTE 2/5 - Principio de Equilibrio + DRF Básico con nombres corregidos
partes: 2/5
estado: completo
...
apps/utils/            (Sin prefijo)   SoftDeleteMixin
                                       TimeStampedModel

apps/core/             ❌ DEPRECADO    (Eliminar completamente)
```
...
# → Genérico ✅ (va en utils/, sin prefijo)
...
**Continúa en:** CLEAN_CODE_NAMING_PRINCIPLES_v2_3_1_PARTE_3.md
