...
changelog: PARTE 1/5 - Principios Fundamentales + Nombres de modelos corregidos
partes: 1/5
estado: completo
...
```
MODELOS CORREGIDOS (apps/ivr/):
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

❌ v2.3.0 (INCORRECTO):          ✅ v2.3.1 (CORRECTO):
├─ HistoricoT1                   ├─ CallRecord
├─ ReporteTrimestral             ├─ QuarterlyReport
├─ Menu2                         ├─ IVRMenu
├─ LlamadasAbandonadas           ├─ AbandonedCall
├─ ClientesUnicos                ├─ UniqueClient
└─ PromedioClientesMenu          └─ AverageClientPerMenu

RAZONES:
✅ Código en INGLÉS (regla de idioma)
✅ Sin números arbitrarios (anti-pattern 28.4)
✅ Nombres auto-documentados
✅ Mapeo a tablas legacy con db_table
```
...
✅ CORRECTO - Arquitectura por dominio:
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

iact/
├── reports/         # ← Organizado por dominio de negocio
├── dashboard/
├── access/          # (RBAC)
├── ivr/             # (Adaptador IVR)
└── pipeline/        # (Monitoreo ETL)

Revela inmediatamente: sistema de call center con reportes y dashboards.
```
...
│
├── ivr/              # Adaptador a datos IVR (READ-ONLY)
...
**Continúa en:** CLEAN_CODE_NAMING_PRINCIPLES_v2_3_1_PARTE_2.md
