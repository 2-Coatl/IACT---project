...
changelog: |
  v3.0.1 - PARTE 1/5 - apps/dashboard/ restaurado
  - CORRECCIÓN: apps/dashboard/ SÍ existe (planificado)
  - Basado en: URLS_REPORTES_Y_DASHBOARDS.md
  - Arquitectura: apps/reports/ + apps/dashboard/
  - DashboardService restaurado con ejemplos correctos
  v3.0.0 - PARTE 1/5 - Arquitectura corregida (error: eliminó dashboard)
  - ERROR: Eliminó apps/dashboard/ (que sí debe existir)
partes: 1/5
estado: completo
revision: v3.0.1 (arquitectura completa con dashboard)
replaces: CLEAN_CODE_NAMING_PRINCIPLES_v3_0_0_PARTE_1.md
---
...
APPS REALES IACT (basado en URLS_REPORTES_Y_DASHBOARDS.md):
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

✅ apps/access/        Control de acceso RBAC
✅ apps/audit/         Auditoría de acciones
✅ apps/authentication/ Autenticación usuarios
✅ apps/core/          Modelos abstractos base (SOLO abstract=True)
✅ apps/dashboard/     Visualización con WIDGETS (planificado)
✅ apps/ivr_legacy/    Adaptador datos IVR
✅ apps/pipeline/      Monitoreo ETL
✅ apps/reports/       Reportes tabulares
✅ apps/users/         Gestión usuarios
✅ apps/utils/         Funciones helper (SOLO funciones)

DIFERENCIA CLAVE apps/reports/ vs apps/dashboard/:
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
apps/dashboard/    → Visualización con WIDGETS en vivo
...
class DashboardService:  # ✅ Servicio de dashboards
    """Gestión de lógica de negocio para dashboards."""
    pass
```
...
class DashboardService:
    ...
    @staticmethod
    def get_quarterly_metrics(quarter: str):
        """Obtiene métricas trimestrales para dashboard."""
        # Retorna dict con KPIs
        pass
```
...
def retrieve_dashboard(dashboard_id):  # ❌ ¿Por qué "retrieve"?
    pass
...
class DashboardService:
    """Servicio de dashboards."""  # ← Español
    ...
    @staticmethod
    def get_client_analysis(quarter: str, did: str):
        """Obtiene análisis de clientes."""
        pass
    
    @staticmethod
    def get_ivr_performance(start_date, end_date):
        """Obtiene performance del IVR."""
        pass
```
...
reportes, dashboards y adaptador a IVR.
```
...
├── services.py
│   ├── DashboardService
│   │   ├── get_quarterly_metrics()           # UC-006
│   │   ├── get_client_analysis()             # UC-007
│   │   └── get_ivr_performance()             # UC-008
│   │
│   └── WidgetService
│       ├── generate_kpi_widget()             # UC-009
│       └── generate_chart_widget()           # UC-010
...
**Continúa en:** CLEAN_CODE_NAMING_PRINCIPLES_v3_0_1_PARTE_2.md
...
- ✅ Apps reales documentadas (con apps/dashboard/)
- ✅ apps/reports/ → Reportes tabulares
